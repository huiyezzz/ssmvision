...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" method="post" action="login.action">
		<DIV id=UpdatePanel1>
		              								...
		              								<TBODY>
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px" width=150>
										                		<INPUT id=txtName style="WIDTH: 130px" name=u_name></TD>
										              	...
										              	<TR>
											                ...
											                <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" type=password name=u_password></TD>
